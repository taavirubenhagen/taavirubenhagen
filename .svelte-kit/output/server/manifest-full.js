export const manifest = {
	...
	_: {
		...
		routes: [
			...
			{
				id: "/main/newsletter",
				pattern: /^\/main\/newsletter\/?$/,
				params: [],
				page: { layouts: [0,2,], errors: [1,,], leaf: 10 },
				endpoint: null
			},
			{
				id: "/main/presenter/download",
				pattern: /^\/main\/presenter\/download\/?$/,
				params: [],
				page: { layouts: [0,2,], errors: [1,,], leaf: 11 },
				endpoint: null
			},
			{
				id: "/main/presenter/privacy-policy",
				pattern: /^\/main\/presenter\/privacy-policy\/?$/,
				params: [],
				page: { layouts: [0,2,], errors: [1,,], leaf: 12 },
				endpoint: null
			},
			{
				id: "/main/presenter/waitlist",
				pattern: /^\/main\/presenter\/waitlist\/?$/,
				params: [],
