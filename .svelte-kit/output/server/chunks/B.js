...
/* empty css        */const B = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<t class="${"transition duration-200 " + escape(simple ? "" : "underline underline-offset-8", true) + " " + escape(
    onPrimary ? "text-onPrimary hover:text-neutral-300" : "text-onBackground hover:text-neutral-600",
    true
