...
const Icon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<img src="${"/tavy/icons/" + escape(tavyVersion, true) + "/" + escape(name, true) + ".svg"}"${add_attribute("alt", name, 0)}${add_attribute("class", inverted ? "invert" : "", 0)} style="${"height: " + escape(size / 16 * 1.25, true) + "rem;"}">`;
});
export {
  Icon as I
};
