...
const Title_section = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Interactive, "Interactive").$$render($$result, { state: sectionCursorState }, {}, {
    default: () => {
      return `<section class="${escape(sectionClass, true) + " w-screen h-screen " + escape(primary ? "primary" : "background", true) + " p-64 flex_col_center relative text-center"}">${slots.default ? slots.default({}) : ``}
