...
const H2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<t class="text-6xl md:text-7xl selection:primary font-bold">${slots.default ? slots.default({}) : ``}</t>`;
});
...
<main><div class="w-full min-h-screen sm:p-16 flex flex-col justify-center items-center lg:items-start"><div class="flex flex-col items-start">${validate_component(O1, "O1").$$render($$result, {}, {}, {
    ...
    <div class="relative pb-[100vh] primary" style="${"height: " + escape(phoneMockupSectionHeight, true) + "px;"}"><div class="sticky top-[25vh] h-[50vh] center_col text-onPrimary"${add_attribute(
    "style",
    "",
    0
