...
<main class="${"w-screen min-h-screen background"}">
  ...
  <button class="${"fixed z-40 right-6 bottom-8 invert hover:invert shadow-xl rounded-full border-2 border-primary " + escape("w-16 h-16", true) + " bg-onPrimary flex_row_center default_animation_long"}"${add_attribute(
    "style",
    "",
    0
