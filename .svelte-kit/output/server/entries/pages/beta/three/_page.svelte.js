import { g as getContext, s as setContext, o as onDestroy, c as create_ssr_component, d as add_attribute, f as createEventDispatcher, v as validate_component } from "../../../../chunks/index2.js";
...
const Primitive = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { object } = $$props;
  let { position: position$1 = position } = $$props;
  let { rotation: rotation$1 = rotation } = $$props;
  let { scale: scale$1 = scale } = $$props;
...
const css = {
  code: ".controls.svelte-zffy9p{position:absolute;left:1em;top:1em}label.svelte-zffy9p{display:flex;width:60px;gap:0.5em;align-items:center}input.svelte-zffy9p{width:80px;margin:0}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let spin = 0;
  $$result.css.add(css);
  return `${validate_component(Canvas, "SC.Canvas").$$render(
    $$result,
    {
      antialias: true,
    ...
    {
      default: () => {
        return `${validate_component(Group, "SC.Group").$$render($$result, { position: [0, -height / 2, 0] }, {}, {
          default: () => {
            return `${validate_component(Mesh, "SC.Mesh").$$render(
              $$result,
              {
		...
		${validate_component(Primitive, "SC.Primitive").$$render(
              $$result,
              {
	...
	${validate_component(Mesh, "SC.Mesh").$$render(
          $$result,
          {
            geometry: new THREE.BoxGeometry(),
            material: new THREE.MeshStandardMaterial({ color: 16727552 }),
	...
	${validate_component(PerspectiveCamera_1, "SC.PerspectiveCamera").$$render(
          $$result,
          {
            position: [1, 1, 3],
            zoom: zoom * 0 + 1,
	...
	${validate_component(OrbitControls_1, "SC.OrbitControls").$$render(
          $$result,
          {
            enableZoom: true,
	...
	${validate_component(AmbientLight, "SC.AmbientLight").$$render($$result, { intensity: 0.6 }, {}, {})}
	${validate_component(DirectionalLight, "SC.DirectionalLight").$$render(
          $$result,
          {
            intensity: 0.6,
            position: [-2, 3, 2],
...
<div class="${"controls svelte-zffy9p"}"><label class="${"svelte-zffy9p"}"><input type="${"range"}"${add_attribute("min", 0.1, 0)}${add_attribute("max", 3, 0)}${add_attribute("step", 0.1, 0)} class="${"svelte-zffy9p"}"${add_attribute("value", width, 0)}> width</label>
	<label class="${"svelte-zffy9p"}"><input type="${"range"}"${add_attribute("min", 0.1, 0)}${add_attribute("max", 3, 0)}${add_attribute("step", 0.1, 0)} class="${"svelte-zffy9p"}"${add_attribute("value", height, 0)}> height</label>
	<label class="${"svelte-zffy9p"}"><input type="${"range"}"${add_attribute("min", 0.1, 0)}${add_attribute("max", 3, 0)}${add_attribute("step", 0.1, 0)} class="${"svelte-zffy9p"}"${add_attribute("value", depth, 0)}> depth</label>
</div>`;
});
export {
  Page as default
