...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <header class="${"fixed z-20 w-full h-0 flex flex-col md:flex-row justify-start md:justify-center items-center"}">${validate_component(DeviceDetector, "DeviceDetector").$$render($$result, { showInDevice: "desktop" }, {}, {
    default: () => {
