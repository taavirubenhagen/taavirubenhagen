...
<Modal open={helpModalIndex != 0} onDismissed={() => helpModalIndex = 0}>
    <div class="text-left">
        {#if helpModalIndex == 1}
            <P3>A MacOS version is planned, yet it is really hard to build because I don't have a Mac myself. If you want to help to make it happen, <B><a href="TODO: /contact">contact me</a></B>.</P3>
