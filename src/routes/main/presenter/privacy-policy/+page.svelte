...
<main class="max-w-screen min-h-screen p-8 pt-16">
    ...
    <br/>
    <br/>
    <P1>What data do we collect, how do we collect it and how will we use it?</P1><br/>
    <br/>
    ...
    <br/>
    <br/>
    <P1>How do we store your data?</P1><br/>
    <br/>
    ...
    <br/>
    <br/>
    <P1>What are your data protection rights?</P1><br/>
    <br/>
    ...
    <br/>
    <br/>
    <P1>Privacy policies of other websites</P1><br/>
    <br/>
    ...
    <br/>
    <br/>
    <P1>Changes to our privacy policy</P1><br/>
    <br/>
